...
public class ItemToolHoeObsidianReinforced extends ItemHoe {
	
	public static final String name = "itemToolHoeObsidianReinforced";	
	  
	public ItemToolHoeObsidianReinforced() { 
