...
public class ItemToolHammerObsidianReinforced extends ItemToolHammer {
	
	public static final String name = "itemToolHammerObsidianReinforced";	
	  
	public ItemToolHammerObsidianReinforced() { 
		super(8.0F, ItemRegistry.obsidian_reinforced);
