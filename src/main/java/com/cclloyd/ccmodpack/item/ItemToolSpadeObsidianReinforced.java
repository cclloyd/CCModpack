...
public class ItemToolSpadeObsidianReinforced extends ItemSpade {
	
	public static final String name = "itemToolSpadeObsidianReinforced";	

	public ItemToolSpadeObsidianReinforced() { 
