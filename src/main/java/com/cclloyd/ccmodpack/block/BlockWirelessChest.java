...
public class BlockWirelessChest extends BlockContainer {
	...
	public final static String name = "wirelessChest";
	
	public BlockWirelessChest()
	{
		super(Material.rock);
		setUnlocalizedName(CCModpack.MODID + "_" +  name);
		this.setCreativeTab(CreativeTabs.tabRedstone);     // the block will appear on the Blocks tab.
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new EntityWirelessChest();
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		playerIn.openGui(CCModpack.instance, GuiHandlerRegistry.GUI_WIRELESS_CHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
