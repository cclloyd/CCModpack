...
public class ItemToolHammerObsidian extends ItemToolHammer {
	
	public static final String name = "itemToolHammerObsidian";
			  
	public ItemToolHammerObsidian() { 
		super(5.0F, ItemRegistry.obsidian);
