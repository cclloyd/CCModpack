...
public class ItemArmorChestObsidian extends ItemArmor {
	
	public static final String name = "itemArmorChestObsidian";
	
	public ItemArmorChestObsidian() { 
		super(ItemRegistry.armorObsidian, 0, 1);
